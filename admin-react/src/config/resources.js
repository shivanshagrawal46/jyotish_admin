...
export const resources = {
  ...
  bookNames: {
    ...
    columns: [{ name: 'book_image', title: 'Image', type: 'image' }, 'name', 'author'],
    expandFields: ['acknowledgement_content'],
    fields: [
      f('name', 'Name', 'text', { required: true }),
      f('author', 'Author', 'text', { col: 12 }),
      f('publications', 'Publications', 'text', { col: 12 }),
      f('isbn_no', 'ISBN No.', 'text', { col: 12 }),
      f('acknowledgement_title', 'Acknowledgement Title', 'text'),
      f('acknowledgement_content', 'Acknowledgement Content', 'richtext'),
      f('book_image', 'Book Image', 'image'),
    ],
  },
  bookChapters: {
    label: 'Book Chapters',
  ...
  celebrityKundli: {
    ...
    fields: [
      ...
      f('latitude', 'Latitude', 'number', { col: 12 }),
      f('longitude', 'Longitude', 'number', { col: 12 }),
